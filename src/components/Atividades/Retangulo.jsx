...
const Retangulo = ({mousePosition}) => {
    ...
    const changeComprimento = e => HandleChange(e, setComprimento)
    const changeLargura = e => HandleChange(e, setLargura)

    const CalcularArea = () => {
        let resultado = parseFloat(comprimento * largura)
    ...
    return (
        ...
        >
            <h3 className="left-10 text-3xl font-bold text-white">Calcular Área Retangulo</h3>
            <div className='mt-5 flex flex-col gap-3'>
                <input onChange={changeComprimento} type='number' placeholder='Comprimento' className='bg-transparent outline-none border-none text-lg text-white' />
                <input onChange={changeLargura} type='number' placeholder='Largura' className='bg-transparent outline-none border-none text-lg text-white' />
            ...
            <div className='absolute flex justify-center items-center w-fit h-[30%] md:h-[80%] bottom-5 right-5'>
                <div className='relative w-full h-full flex justify-center items-center '>
                    <RectangleHorizontal className='text-white/80 w-full h-full' />
